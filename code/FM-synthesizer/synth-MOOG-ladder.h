...
namespace SFM
{
	namespace MOOG
	{
		...
		static void SetCutoff(float cutoff)
		{
		...
		static void SetResonance(float resonance)
		{
		...
		static void Filter(float *pDest, unsigned numSamples, float wetness)
		{
			...
			for (unsigned iSample = 0; iSample < numSamples; ++iSample)
			{
				...
				// Round off and mix  (FIXME: atanf() LUT)
