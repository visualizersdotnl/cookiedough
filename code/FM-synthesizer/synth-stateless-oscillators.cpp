...
namespace SFM
{
	...
	*/
	...
	static WavetableOscillator s_guitarOsc(g_wavGuitar, sizeof(g_wavGuitar), 1, -4, 1.f*130.81f);           // Tuned OK
	static WavetableOscillator s_elecPianoOsc(g_wavElecPiano, sizeof(g_wavElecPiano), -1, -3, 1.f*261.63f); // Tuned OK
